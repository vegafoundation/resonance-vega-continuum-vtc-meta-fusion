...
\title{VEGA CONTINUUM VTC META FUSION: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, VEGA CONTINUUM VTC META FUSION'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
